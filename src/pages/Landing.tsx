    ...
    <div className="min-h-screen bg-[var(--color-bg)] text-[var(--color-text)]">
      <header className="flex items-center justify-between border-b border-[var(--color-border)] px-6 py-4">
        ...
        <div className="flex items-center gap-4">
          <AccessibilityBar />
          <Link to="/login" className="rounded-full border border-[var(--color-border)] px-4 py-2 text-sm">
            Mag-login
          </Link>
          <Link
            to="/signup"
            className="rounded-full bg-[var(--color-primary)] px-4 py-2 text-sm font-medium text-white hover:bg-[var(--color-primary-hover)]"
          >
            Mag-sign up
          </Link>
        </div>
      ...
      <main className="mx-auto max-w-4xl px-6 py-16 text-center">
        ...
        <div className="mt-6 flex items-center justify-center gap-3">
          ...
          <Link
            to="/signup"
            className="rounded-full bg-[var(--color-primary)] px-6 py-3 text-base font-medium text-white hover:bg-[var(--color-primary-hover)]"
          >
          ...
          {FEATURES.map((f) => (
            <div key={f.title} className="rounded-2xl border border-[var(--color-border)] bg-[var(--color-surface)] p-6">
              <h2 className="mb-2 flex items-center gap-2 text-lg font-semibold">
                <IconLabel icon={f.icon} label={f.title} />
              </h2>
